...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Apogee-dev.
...
- __Website__ refers to Apogee-dev, accessible from [Http://www.apogee-dev.com](Http://www.apogee-dev.com)
